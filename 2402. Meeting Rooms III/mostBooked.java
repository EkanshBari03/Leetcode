class Solution {
    public int mostBooked(int n, int[][] meetings) {
        ...
        Arrays.sort(meetings, (a, b) -> Integer.compare(a[0], b[0])); // sort by starting time of meetings

        int[] roomsUsedCount = new int[n]; // Each room is used 0 times in the beginning
        long[] lastAvailableAt = new long[n]; // Each room will be last available at
